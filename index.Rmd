...
3. I train a random forest model on the final features.I find its accuracy to be ~97%.I set the number of trees to 200 beacuse further increase in this value does not impact the accuracy of the model.
```{r}
<<randomForest>>
```
